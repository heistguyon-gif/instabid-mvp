...
export default function RulesPage() {
  return <InfoPage eyebrow="Transparência do produto · Product transparency" title="As regras precisam caber na tela — e resistir a uma disputa." lead="O Instabid vende exposição patrocinada mensurável. Não vende prêmio, sorte, seguidores ou garantia de retorno.">
    ...
    <h2>2. Entrada e ultrapassagem</h2><p>Entrada mínima: R$ 5 no BR. Os lances avançam em reais inteiros e, para ultrapassar uma posição, o total precisa excedê-la pelo incremento exibido. Um perfil que já está no ranking paga apenas a diferença até o novo total.</p>
    <p>Um Pix pendente pode ser fechado e retomado no mesmo navegador. Gerar outra cobrança não cancela automaticamente uma anterior; por isso, o checkout mantém a cobrança atual disponível até a confirmação ou expiração.</p>
