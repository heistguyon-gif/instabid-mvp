...
export default function RulesPage() {
  return <InfoPage eyebrow="Transparência do produto · Product transparency" title="As regras precisam caber na tela — e resistir a uma disputa." lead="O Instabid vende exposição patrocinada mensurável. Não vende prêmio, sorte, seguidores ou garantia de retorno.">
    <p className="notice"><b>Piloto:</b> nenhuma cobrança está ativa. Candidaturas e valores pretendidos servem para validar demanda enquanto buscamos aprovação escrita do processador de pagamentos.</p>
    ...
    <h2>English summary</h2><p>Confirmed boosts determine rank; ties favor the earlier total. Paid placement is always disclosed. Clicks are server-counted with repeat and bot filtering. No prize, sales, follower, or return guarantee is offered. Moderation happens before charging.</p>
  </InfoPage>;
}
