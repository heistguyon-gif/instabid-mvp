...
const demoListings = [
  ['br-nexoflow', 'br', 'NexoFlow', '@nexoflow.app', 'Publique e acompanhe conteúdo profissional em escala.', 'https://instagram.com/nexoflow.app', 'demo@instabid.br', 'Ferramentas', '1284'],
  ['br-atlas', 'br', 'Clube Atlas', '@clubeatlas.br', 'Comunidade para creators construindo negócios digitais.', 'https://instagram.com/clubeatlas.br', 'demo@instabid.br', 'Comunidades', '946'],
  ['br-marca', 'br', 'Marca em Jogo', '@marcaemjogo', 'Estratégia de marca para quem vende pela internet.', 'https://instagram.com/marcaemjogo', 'demo@instabid.br', 'Serviços', '721'],
  ['br-creatoros', 'br', 'CreatorOS', '@creatoros.br', 'Operação simples para creators profissionais.', 'https://instagram.com/creatoros.br', 'demo@instabid.br', 'Ferramentas', '508'],
  ['br-neblina', 'br', 'Loja Neblina', '@loj_neblina', 'Produtos autorais em pequenas coleções.', 'https://instagram.com/loj_neblina', 'demo@instabid.br', 'Marcas', '364'],
...
export async function getLeaderboard(market: 'br' | 'world') {
  ...
  const result = await db.prepare(`SELECT
      ...
      s.ends_at AS endsAt, COALESCE(SUM(b.amount_minor), 0) AS totalMinor
    FROM listings l
